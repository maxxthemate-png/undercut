  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <section className="max-w-3xl mx-auto px-6 pt-16 pb-8 text-center">
        ...
        <p className="mt-4 text-gray-600">Know the <b>minimum offer worth accepting</b> before the offers arrive — and set auto-accept/auto-decline so eBay negotiates for you.</p>
      </section>
      ...
      <section className="max-w-3xl mx-auto px-6 py-10 border-t border-gray-100">
        ...
        <div className="space-y-4 text-gray-700 text-[15px] leading-relaxed">
          ...
          <p>
            That&apos;s the same principle behind floor-first repricing: <Link href="/" className="text-blue-600 font-medium">Undercut</Link> beats the lowest competitor automatically but never crosses the per-item floor you set. Work the full math in the <Link href="/ebay-fee-calculator" className="text-blue-600 font-medium">fee calculator</Link>, or read the <Link href="/guides/ebay-price-floor" className="text-blue-600 font-medium">price-floor guide</Link>.
          </p>
        </div>
      </section>
      <section className="max-w-2xl mx-auto px-6 py-12 text-center">
        <h2 className="text-2xl font-bold">Automate the rest of your pricing too.</h2>
        <p className="text-gray-600 mt-2 mb-5">Undercut reprices every listing against the lowest competitor — floor-protected, 24/7. Start free, no card.</p>
