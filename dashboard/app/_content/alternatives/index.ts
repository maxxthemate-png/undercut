...
export const alternatives: PageContent[] = [
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": "Knowing what to enter as your floor is as important as having one. Take a typical electronics accessory: cost of goods $8.00, outbound shipping $4.00, eBay final value fee 13.6% of sale price, and a minimum acceptable margin of 15%. Solving for floor price P where P × (1 − 0.136) − $12.00 ≥ 0.15 × P gives P ≥ $16.72. Enter $16.72 as your hard floor in Undercut for that listing. No matter how aggressively competitors drop, Undercut will not touch that listing below $16.72. The same logic applies to any category — swap in your actual fees, shipping, and margin target. Undercut's eBay profit calculator (linked below) can walk through the arithmetic for you."
      },
      {
