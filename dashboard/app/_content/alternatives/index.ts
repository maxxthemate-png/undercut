...
export const alternatives: PageContent[] = [
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": "Knowing what to enter as your floor is as important as having one. Take a typical electronics accessory: cost of goods $8.00, outbound shipping $4.00, eBay final value fee 13.6% of sale price, and a minimum acceptable margin of 15%. Solving for floor price P where P × (1 − 0.136) − $12.00 ≥ 0.15 × P gives P ≥ $16.81. Enter $16.81 as your hard floor in Undercut for that listing. No matter how aggressively competitors drop, Undercut will not touch that listing below $16.81. The same logic applies to any category — swap in your actual fees, shipping, and margin target. Undercut's eBay profit calculator (linked below) can walk through the arithmetic for you."
      },
      {
    ...
    "sections": [
      {
        ...
        "body": "A hard floor is a per-item minimum price that Undercut will never reprice below, no matter what competitors do. You calculate it once per SKU and Undercut enforces it automatically on every reprice cycle.\n\nWorked example — a used electronics accessory:\n- Cost of goods: $8.00\n- Shipping: $4.00\n- eBay final value fee (13.6%): ~$2.31 on a $17 sale\n- Minimum margin target: 15%\n\nFloor calculation: ($8.00 + $4.00) / (1 − 0.136 − 0.15) ≈ $16.81\n\nYou enter $16.81 as the floor. If every competitor drops to $14, Undercut holds at $16.81 and stops — it does not follow the market off a cliff. This is the core reason sellers who have burned margin with aggressive repricers switch to a floor-first tool.",
        "bullets": [
  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": "Every repricing tool claims to protect your margins. Undercut enforces it at the listing level, not the account level, with a hard floor you set per item. The repricer will undercut the lowest competitor price to win the sale — but it will never go below your floor, no matter how aggressive the competition gets.\n\nHere is a concrete example using a used electronics accessory:\n\n- Item cost: $8.00\n- Shipping cost: $4.00\n- eBay Final Value Fee (13.6% of sale price + $0.30): variable\n- Minimum target margin: 15%\n\nWorking backward: if total costs excluding fees are $12.00, and you need 15% margin after a ~13.6% fee, the floor calculation is roughly: floor = $12.00 / (1 - 0.136 - 0.15) = $12.00 / 0.714 ≈ $16.81. You enter $16.81 as your hard floor in Undercut. The repricer does the rest — competing down to that number and stopping cold. You never sell below cost by accident.",
        "bullets": [
  ...
  },
  {
    ...
    "sections": [
      {
        ...
        "body": "Most repricing tools let you set a global minimum price. Undercut lets you set a floor on each individual listing, calculated around your actual cost structure. Consider a used electronics item: cost $8, shipping $4, eBay fees 13.6%, and your minimum margin target of 15%. Working through the math — total cost basis is $12, fees on the sale price add roughly $1.63 at a $12 price point, and a 15% margin on cost requires about $1.80 profit — your floor lands at approximately $14.97 to $15.43 depending on final fee rounding. In Undercut you enter that number once per listing. The repricer will go as low as that number to win the sale, and will never go lower, regardless of what a competitor does. SKU Grid's floor logic is tied to its supplier cost-sync workflow, which is purpose-built for dropship margin math, not for owned-inventory sellers working from their own cost records.",
        "bullets": [
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Add your item cost, your actual shipping cost, and eBay's fee percentage (typically 13.6% for most categories, plus a $0.30 fixed fee), then add your minimum acceptable margin on top. For example: item cost $8, shipping $4, eBay fees ~13.6% of sale price, 15% margin target gives you a floor in the $15 to $15.50 range. Undercut's pricing guide and the eBay profit calculator linked below walk through this in detail."
      },
      {
  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": "Most repricers chase the lowest price. Undercut does too — but only down to a floor you define per listing. That floor is not a percentage of your current price; it is a hard absolute number you set based on your actual costs. Here is a worked example for a common electronics accessory:\n\nCost of goods: $8.00\nShipping cost: $4.00\neBay final value fee (13.6%): ~$2.18 on a $16 sale\nPayPal/payment processing (~2.9%): ~$0.46\nMinimum margin target: 15%\n\nFloor calculation: ($8.00 + $4.00) / (1 - 0.136 - 0.029 - 0.15) = $12.00 / 0.685 ≈ $17.52\n\nYou set $17.52 as the hard floor for that listing. Undercut will reprice aggressively down to $17.53 to beat every competitor — and stop there. The repricing engine cannot override it. This is not a soft warning or a suggested minimum; it is a structural ceiling on how low automation can go.",
        "bullets": []
      },
      {
  ...
  },
  {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Every listing gets its own floor, set individually inside Undercut. There is no CSV floor import. You can set floors in bulk as a percentage below each listing's current price and then adjust individual listings, or set each one directly. Either way the floor is enforced on every plan, including Free, and no repricing logic can breach it — and a listing with no floor never reprices at all."
      },
      {
